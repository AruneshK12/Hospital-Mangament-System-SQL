...
import {getAllHospitals, getPatientsByDocRating} from "../apis/AdminApis";




function PatientsByDocRating() {
    ...
    const getRatingBasedPatients = async () => {
        try {
            setLoading(true);
            const response = await getPatientsByDocRating(rating);
        ...
        <div style={{marginLeft: "3rem", marginRight: "3rem"}}>
            ...
            >
                <Typography variant="h4" style={{ marginTop: "3rem", marginBottom: "1rem" }}>
                    View All Patients based on the doctor's rating
                </Typography>
            </Box>
            <Box
                display="flex"
...
export default PatientsByDocRating;